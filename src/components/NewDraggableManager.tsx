...
const NewDraggableManager = React.forwardRef<HTMLDivElement, DraggableManagerProps>((props, ref) => {
...
NewDraggableManager.displayName = 'NewDraggableManager'
export default React.memo(NewDraggableManager)
